document.addEventListener("DOMContentLoaded", () => {
  ...
  { 
    ...
    task: "Практическое задание: запишите цели и шаги в ежедневник. Уделите 30 минут для этого.",
...
{ 
  ...
  task: "Практическое задание: Попробуйте 4 сессии Pomodoro по 25 минут и запишите результаты.", 
  guide: "Установите таймер на 25 минут, работайте над одной задачей без перерывов. После 25 минут сделайте 5-минутный перерыв."
},
{ 
  title: "Урок 3: Работа с мотивацией", 
  description: "Научитесь поддерживать мотивацию на протяжении всего дня.", 
  task: "Практическое задание: Найдите 3 вещи, которые мотивируют вас, и запишите их.", 
  guide: "Определите внутренние и внешние источники мотивации и следите за своими эмоциональными реакциями в течение дня."
},
{ 
  title: "Урок 4: Личная эффективность", 
  description: "Определите свои сильные и слабые стороны и работайте над ними.", 
  task: "Практическое задание: Составьте список дел и выполните их по приоритетам.", 
...
{ 
  ...
  task: "Практическое задание: Уделите 30 минут на развитие нового навыка.", 
  guide: "Примените метод «10 000 часов» для постоянной практики или используйте короткие, но регулярные сессии для поддержания фокуса."
},
{ 
  title: "Урок 6: Эмоциональный интеллект", 
  description: "Работайте над своим эмоциональным интеллектом.", 
  task: "Практическое задание: Проанализируйте свои эмоции в течение дня и запишите свои наблюдения.", 
...
{ 
  ...
  task: "Практическое задание: Примите участие в 10-минутной медитации.", 
  guide: "Попробуйте технику глубокого дыхания или прогрессивную мышечную релаксацию для снижения стресса."
},
{ 
  title: "Урок 8: Осознанность", 
  description: "Развивайте осознанность через ежедневную практику.", 
  task: "Практическое задание: Медитируйте 15 минут и записывайте свои ощущения.", 
  guide: "Обратите внимание на свои мысли, ощущения и эмоции во время медитации, не пытаясь их изменить."
},
{ 
  title: "Урок 9: Анализ и рефлексия", 
  description: "Научитесь анализировать свои успехи и неудачи.", 
  task: "Практическое задание: Запишите 3 достижения и 3 урока, которые вы извлекли за неделю.", 
...
{ 
  ...
  task: "Практическое задание: Сформулируйте 3 новые цели на следующий месяц.", 
